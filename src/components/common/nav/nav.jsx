...
const Nav = ({ signOut, profile }) => {
  ...
  return (
    <nav>
      <AppBar
        position="relative"
        style={{ backgroundColor: "#02a39b", marginLeft: open && isLaptop === false ? 300 : 0 }}
      >
        ...
        <div className="bg overflow-hidden">
          ...
          <Divider /> */}
            <List>
              ...
              >
                {/* <ListItemIcon>
                  <i className="fas fa-home bg-white fa-2x"></i>
                </ListItemIcon> */}
                <ListItemText><span className="fw-bold ms-3">Dashboard</span></ListItemText>
              </ListItem>
              <ListItem
                button
                onClick={() => {
              ...
              >
                {/* <ListItemIcon>
                  <i className="fas bg-white fa-2x fa-users"></i>
                </ListItemIcon> */}
                <ListItemText><span className="fw-bold ms-3">Profile</span></ListItemText>
              </ListItem>
              <ListItem
                button
                onClick={() => {
              ...
              >
                {/* <ListItemIcon>
                  <i className="fas fa-university bg-white fa-2x"></i>
                </ListItemIcon> */}
                <ListItemText><span className="fw-bold ms-3">Lectures</span></ListItemText>
              </ListItem>
              <ListItem
                button
                onClick={() => {
              ...
              >
                ...
                <ListItemText><span className="fw-bold ms-3">Quizizz</span></ListItemText>
              </ListItem>
              <ListItem
                button
                onClick={() => {
              ...
              >
                ...
                <ListItemText><span className="fw-bold ms-3">Assignments</span></ListItemText>
              </ListItem>
            </List>
          </div>
        </div>
