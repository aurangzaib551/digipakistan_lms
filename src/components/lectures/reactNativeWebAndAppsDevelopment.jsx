...
const ReactNativeWebAndAppsDevelopment = ({ profile, uid }) => {
  // State
  ...
  return profile ? (
    <>
      <Nav />
      <div className="container mt-lms lectures my-5">
...
export default connect(mapStateToProps)(ReactNativeWebAndAppsDevelopment);
